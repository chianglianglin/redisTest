package com.ws.project.model.bo;


import com.ws.project.model.po.SimpleBaseEntity;
...
public class TaskJobDetailBo extends SimpleBaseEntity {
	/**
	 *
	 */
	...
	public TaskJobDetailBo(Integer id, Long taskJobId, String country, String city, String ip, String url, String isp, Integer statusCode, Long size, String nslookupDuration, String totalDuration, Date connectTime, Date doneTime, String deviceIp, String deviceCountry, String deviceProvince, String deviceCity, String deviceIsp, String deviceMac) {
		this.id = id;
	...
	public TaskJobDetailBo(TaskJobDetail taskJobDetail,String url){
